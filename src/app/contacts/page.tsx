...
const faq = [
  ...
  { q: 'Как работают мастера?', a: 'Каждый мастер — уникальный специалист с собственным стилем и специализацией. Они создают персонализированные расклады на основе ваших данных и многолетнего опыта.' },
